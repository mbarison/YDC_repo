  ...
  <BODY>
    <CENTER>
	  ...
	  <TD align="center" style="background-image:url(/<? if ($page == "index_test") echo 'buttonselect_test'; else echo 'buttonback_test' ?>.jpg)"><A HREF="/index_test.php" class="navbar"><IMG class="navbar" SRC="/eighthnote.gif" ALT="Bullet"> Home</a></TD>
          ...
          <TD align="center" style="background-image:url(/<? if ($page == "concerts_test" || $page == "concerts2" || $page == "tickets" || $page == "tickets_fr") echo 'buttonselect_test'; else echo 'buttonback_test' ?>.jpg)"><A HREF="/concerts_test.php" class="navbar"><IMG class="navbar" SRC="/eighthnote.gif" ALT="Bullet"> Concerts and music</a></TD>
