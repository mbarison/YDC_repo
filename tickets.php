...
Online Ticket Purchase - Global Sounds
</P>
...
<INPUT TYPE="HIDDEN" NAME="redirect" VALUE="http://www.yellowdoorchoir.com/ticketpay.php">
  ...
  <table width="500" cellspacing="5" cellpadding="0" border="0">
    ...
    <tr>
      <td style="font-size: 12px;"><label for="FriAdult">Friday, May 27, 2016 7:30PM General Ticket</label></td>
    ...
    <tr>
      <td style="font-size: 12px;"><label for="FriStudent">Friday, May 27, 2016 7:30PM Student Ticket</label></td>
    ...
    <tr>
      <td style="font-size: 12px;"><label for="SatAdult">Saturday, May 28, 2016 7:30PM General Ticket</label></td>
      <td style="font-size: 12px;" align="center">$21.50</td>
      <td align="center">
    ...
    <tr>
      <td style="font-size: 12px;"><label for="SatStudent">Saturday, May 28, 2016 7:30PM Student Ticket</label></td>
      <td style="font-size: 12px;" align="center">$16.50</td>
      <td align="center">
