...
Achat de billets en ligne - A coeur ouvert
</P>
...
<INPUT TYPE="HIDDEN" NAME="redirect" VALUE="http://www.yellowdoorchoir.com/ticketpay.php">
  ...
  <table width="500" cellspacing="5" cellpadding="0" border="0">
    ...
    <tr>
      <td style="font-size: 12px;"><label for="FriAdult">Le vendredi 29 mai 2015 19 h 30 Billet général</label></td>
    ...
    <tr>
      <td style="font-size: 12px;"><label for="FriStudent">Le vendredi 29 mai 2015  19 h  30 Billet étudiant</label></td>
    ...
    <tr>
      <td style="font-size: 12px;"><label for="SatAdult">Le samedi 30 mai 2015  19 h  30 Billet général</label></td>
      <td style="font-size: 12px;" align="center">21,50 $</td>
      <td align="center">
    ...
    <tr>
      <td style="font-size: 12px;"><label for="SatStudent">Le samedi 30 mai 2015 19 h  30 Billet étudiant</label></td>
      <td style="font-size: 12px;" align="center">16,50 $</td>
      <td align="center">
...
<P>
  <table width="750" cellspacing="5" cellpadding="0" border="0">
    ...
    <tr>
      <td align="right" valign="top" style="font-size: 12px;"><label for="Email">Courriel :</label>&nbsp;</td>
      <td>
